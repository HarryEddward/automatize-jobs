...
interface IUseCoverLetter extends IPompt {
...
export default async function useCoverLetterCreator({
    translate_lang,
    formal_training,
    informal_training,
    work_experience,
    ...
    const [resultCoverLetter, setResultCoverLetter] = useState<string>('');

    const resultAi = await useAiChat(
        [
            {
                "role": "system",
    ...
    useEffect(() => {
        ...
        setResultCoverLetter(resultAi);

    },[resultAi]);

  
    return resultCoverLetter
}
